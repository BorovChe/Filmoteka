...
var _moviesListRender = require("./ts/moviesListRender");
var _searchMovies = require("./ts/searchMovies");
var _movieDetailsRender = require("./ts/movieDetailsRender");

},{"./ts/moviesListRender":"dBTCA","./ts/searchMovies":"9go3O","./ts/movieDetailsRender":"3ywo7"}],"dBTCA":[function(require,module,exports) {
var _refs = require("./refs");
var _moviesAPIService = require("./apiService/moviesAPIService");
var _templates = require("./templates/templates");
const test = [];
async function getTrendingMoviesAndUpdateUI() {
    try {
        const { data } = await (0, _moviesAPIService.getTrendingMovies)();
        // test.push(data);
        const movieItems = data.results.map((0, _templates.moviesTemplate)).join("");
        (0, _refs.moviesListRef)?.insertAdjacentHTML("beforeend", movieItems);
    } catch (error) {
        console.log(error);
    }
}
...
},{"./refs":"cWfUz","./apiService/moviesAPIService":"7x1Mj","./templates/templates":"22oQG"}],"cWfUz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// const movieDetailsRefs = {
// };
parcelHelpers.export(exports, "bodyRef", ()=>bodyRef);
parcelHelpers.export(exports, "moviesListRef", ()=>moviesListRef);
parcelHelpers.export(exports, "modalRefs", ()=>modalRefs);
...
},{}],"7x1Mj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getTrendingMovies", ()=>getTrendingMovies);
parcelHelpers.export(exports, "getSearchMovies", ()=>getSearchMovies);
parcelHelpers.export(exports, "getMovieDetails", ()=>getMovieDetails);
parcelHelpers.export(exports, "getMovieVideos", ()=>getMovieVideos);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
(0, _axiosDefault.default).defaults.baseURL = "https://api.themoviedb.org/";
(0, _axiosDefault.default).defaults.headers.common = {
    Authorization: "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI3YzU4OTM3MzlhNzkwZmJjNzM2YWZmNDM4ZmMyMjIyZCIsIm5iZiI6MTcyMTU4MjQ3OS4yNjUxMDQsInN1YiI6IjY2OWQ0MWIzMWRkMDEwYjU1ZGRkNWMwYiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.oT75Tmqq8mBXk-oA__ELZPxaQf-AGunpiBYR9_cjfUg"
};
const getTrendingMovies = async ()=>{
    return await (0, _axiosDefault.default).get(`3/trending/movie/day?language=en-US`);
};
const getSearchMovies = async (value)=>{
    return await (0, _axiosDefault.default).get(`3/search/movie?query=${value}&include_adult=false&language=en-US&page=1`);
};
const getMovieDetails = async (id)=>{
    return await (0, _axiosDefault.default).get(`https://api.themoviedb.org/3/movie/${id}?language=en-US`);
};
const getMovieVideos = async (id)=>{
    return await (0, _axiosDefault.default).get(`3/movie/${id}/videos?language=en-US`);
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"22oQG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "moviesTemplate", ()=>moviesTemplate);
parcelHelpers.export(exports, "movieDetailsTemplate", ()=>movieDetailsTemplate);
const moviesTemplate = ({ id, poster_path, original_title, original_name, release_date })=>{
    return `
...
const movieDetailsTemplate = ({ poster_path })=>{
    return `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9go3O":[function(require,module,exports) {
var _refs = require("./refs");
var _moviesAPIService = require("./apiService/moviesAPIService");
var _templates = require("./templates/templates");
...
async function onSubmit(e) {
    ...
    try {
        const { data } = await (0, _moviesAPIService.getSearchMovies)(searchValue);
        (0, _refs.moviesListRef).innerHTML = "";
        const movieItems = data.results.map((0, _templates.moviesTemplate)).join("");
        (0, _refs.moviesListRef)?.insertAdjacentHTML("beforeend", movieItems);
        console.log(data);
    } catch (error) {}
...
},{"./refs":"cWfUz","./apiService/moviesAPIService":"7x1Mj","./templates/templates":"22oQG"}],"3ywo7":[function(require,module,exports) {
var _refs = require("./refs");
var _moviesAPIService = require("./apiService/moviesAPIService");
var _templates = require("./templates/templates");
var _modal = require("./modal");
(0, _refs.moviesListRef)?.addEventListener("click", onClickMovieItem);
async function onClickMovieItem(e) {
    const li = e.target.closest("li");
    if (!li) return;
    const itemId = li.dataset.id;
    try {
        (0, _modal.onOpenModal)();
        const { data } = await (0, _moviesAPIService.getMovieDetails)(itemId);
        (0, _refs.modalRefs).modal.innerHTML = (0, _templates.movieDetailsTemplate)(data);
    } catch (error) {
        console.log(error);
    }
}

},{"./refs":"cWfUz","./apiService/moviesAPIService":"7x1Mj","./templates/templates":"22oQG","./modal":"jJLaa"}],"jJLaa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "onOpenModal", ()=>onOpenModal);
parcelHelpers.export(exports, "onCloseModal", ()=>onCloseModal);
var _refs = require("./refs");
var _disableScroll = require("./scroll/disableScroll");
(0, _refs.modalRefs).backdrop?.addEventListener("click", onClickBackdrop);
function onOpenModal() {
    window.addEventListener("keydown", onEscKeyDown);
    toggleClassListBody();
    (0, _disableScroll.disableScroll)();
}
...
function toggleClassListBody() {
    (0, _refs.bodyRef).classList.toggle("show-modal");
}

},{"./refs":"cWfUz","./scroll/disableScroll":"65A2P","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"65A2P":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "disableScroll", ()=>disableScroll) // scrollBtn, fixBlocks
;
parcelHelpers.export(exports, "enableScroll", ()=>enableScroll);
var _refs = require("../refs");
function disableScroll() {
    const lockPaddingValue = window.innerWidth - (0, _refs.bodyRef).offsetWidth + "px";
    (0, _refs.bodyRef).style.paddingRight = lockPaddingValue;
    (0, _refs.bodyRef).style.overflow = "hidden";
//   fixBlocks.forEach(e => {
//     e.style.paddingRight = lockPaddingValue;
//   });
}
function enableScroll() {
    (0, _refs.bodyRef).style.paddingRight = "0";
    (0, _refs.bodyRef).style.overflow = "";
//   fixBlocks.forEach((e) => {
//     e.style.paddingRight = "";
//   });
}

},{"../refs":"cWfUz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dZI1r","jeorp"], "jeorp", "parcelRequired76b")
